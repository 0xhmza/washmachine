...
function FrameFinalize() {
  return (
    <Shell crumbs={["build", "finalize"]} pipeActive="fn"
      ...
      <div className="cfg">
        ...
        <Sec title="Packing" action={<Chip>optional · post-backdoor</Chip>}>
          <div className="card">
            <div className="row" style={{ gap: 12 }}>
              <PackCard name="None" sub="Ship binary as-is" selected />
              <PackCard name="UPX" sub="Generic; signature-flagged" warn />
              <PackCard name="Custom RC4" sub="Stub-decrypts at run" />
              <PackCard name="Reflective" sub="In-memory unpack" />
            </div>
          </div>
        </Sec>
      </div>
