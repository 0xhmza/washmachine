...
class text_loader_dll_user_supplied_shellcode_threaded():

    def __init__(self):
        logger.debug("In file {0}".format(str(os.path.abspath(__file__))))
        self.name = "text_loader_dll_user_supplied_shellcode_threaded"
        self.description = """User supplied shellcode payload for DLL text loaders"""
        self.requirements = {'MODE': 'How the patching will happen',
                             'SUPPLIED_SHELLCODE': 'x64 bit Windows Shellcode Payload',
