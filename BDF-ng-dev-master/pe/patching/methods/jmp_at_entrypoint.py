...
class jmp_at_entrypoint:

    def __init__(self):
        logger.debug("In file {0}".format(str(os.path.abspath(__file__))))
        self.name = """jmp_at_entrypoint"""
    ...
    def set_jmp_patch_instr(self):
        ...
        self.BDF.patch_instr[self.BDF.pe_object['LocOfEntryinCode']] = b"\xe9"
    ...
    def patch(self, BDF):
        ...
        self.BDF.core_support = 'jmp_core'
        ...
        _, self.BDF.pe_object['resumeExe'] = targetFile.resume_execution_jmp()
        ...
        # recalling resumeExe
        ReturnTrackingAddress, self.BDF.pe_object['resumeExe'] = targetFile.resume_execution_jmp()
