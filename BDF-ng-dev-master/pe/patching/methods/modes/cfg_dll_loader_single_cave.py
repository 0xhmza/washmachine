...
class cfg_dll_loader_single_cave:

    def __init__(self, BDF=None):
        logger.debug("In file {0}".format(str(os.path.abspath(__file__))))
        self.name = """cfg_dll_loader_single_cave"""
    ...
    def main(self):
        ...
        self.BDF.pe_object['loader_stub'] = loader_tmp_front + struct.pack("<Q", self.BDF.pe_object['CavesPicked'][0][6] - self.second_distance_from_payload_offset + 0x10) + loader_tmp_back
