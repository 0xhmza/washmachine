...
class cfg_loader_single_cave:

    def __init__(self, BDF=None):
        logger.debug("In file {0}".format(str(os.path.abspath(__file__))))
        self.name = """cfg_loader_single_cave"""
    ...
    def main(self):
        ...
        self.BDF.pe_object['loader_stub'] = loader_tmp_front + struct.pack("<Q", self.BDF.pe_object['CavesPicked'][0][6] -
                                                                           self.second_distance_from_payload_offset + 0x10) + loader_tmp_back
    ...
    def find_cave(self):
        ...
        self.BDF.pe_object['len_allshells'] = (self.shellcode_len, )
        self.BDF.SIZE_CAVE_TO_FIND = self.shellcode_len
    ...
    def get_patch_instr(self):
        ...
        for i, item in self.BDF.pe_object['CavesPicked'].items():
            if i == 0:
                ...
                self.BDF.patch_instr[int(self.BDF.pe_object['CavesPicked'][i][1], 16)] = self.completeShellcode
