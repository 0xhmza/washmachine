...
class hook_cfg:
    ...
    def __init__(self):
        ...
        self.name = """hook_cfg"""
        self.description = """Hook Control Flow Guard, works only on PE files with it compiled in"""
    ...
    def patch(self, BDF):
        ...
        self.BDF.core_support = 'cfg_core'
        ...
        self.BDF.pe_object['resumeExe'] = targetFile.resume_execution_cfg()
